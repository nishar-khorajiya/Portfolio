...
import omimage from "./SocialLinks/profile-pic (1).png"
      ...
      <div className="w-full flex justify-around">
        ...
        >
          <div className="w-40 h-40 rounded-full  image">
            <img src={omimage} className="w-screen rounded-lg" />
          </div>
          <h1
          ...
          <div className=" w-96 p-2 flex gap-2 justify-center relative lg:top-10 sm:top-14">
            ...
            >
              <a href="https://www.instagram.com/nishar.03?igsh=MWpoeTMxMjQ4aGI2eQ==" target="#">
                {" "}
            ...
            >
              <a href="https://www.linkedin.com/in/nishar-khorajiya-451b04250/">
                {" "}
            ...
            >
              <a href="https://github.com/nishar-khorajiya" target="#">
                {" "}
