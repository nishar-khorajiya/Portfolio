    ...
    <>
      <div className="relative h-full">
        <div className={`${darkmode==="dark" ? `bg-${bgcolor}` : `bg-white`} p-10 rounded-lg`}>
          ...
          >
            I am pursuing  <span className="font-bold">B.Tech Degree </span>From Chandubhai S Patel Institute of Technology, CHARUSAT,<br /> Anand.
          ...
          >
            ...
            creative way. I <br />
            creates <span className="font-bold">Portal</span> for different domain.<br/>
            <br/>
